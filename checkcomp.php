  ...
  <div class="row">
    <div class="col-sm-4" style="background-color:gray;"><center><font face="tekton pro" size="9" color="black"><u>Admin</u></font>
	  ...
	  <a href="admin3.php"><font face="tekton pro" size="6" color="black">Menu</font></a></br>
        <a href="admfee.php"><font face="tekton pro" size="6" color="black">Complain</font><hr></a></br>
							<div class="col-lg-15">
						      <button type="submit" name="submit" class="btn btn-success">logout</button>
						    </div>
		   ...
		   <table class="table" cellpadding="10" id="tblData">
                ...
                <tbody> 
				 <tr id="border">
                    ...
                    <tr>
						<td align="center" valign="middle"><input class="input-lg" type="text"  name="item"></td>
